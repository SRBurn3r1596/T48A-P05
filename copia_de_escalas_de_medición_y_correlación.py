...
Original file is located at
    https://colab.research.google.com/drive/1IU3Zz6pdrna_LeNjLPUFkd2BhoVZENXb
...
data_model_3 = {
    ...
    'Modelo': ['Model 3', 'Model 3', 'Model 3', 'Model 3', 'Model 3'],
    'Precio (EUR)': [39990, 41990, 43990, 45990, 47990]
}

def regresion_lineal_model_3():
  df = pd.DataFrame(data_model_3)
  y = df['Año']
  x = df['Precio (EUR)']
  x_mean = np.mean(x)
  y_mean = np.mean(y)
  ...
  ordenada_al_origen = y_mean - pendiente * x_mean
  coef = np.corrcoef(x, y)[0, 1]
  tupla_model_3 = (pendiente, ordenada_al_origen, coef)
  return tupla_model_3

tupla_model_3 = regresion_lineal_model_3()
print('pendiente: ' + str(tupla_model_3[0]))
print('ordenada al origen: ' + str(tupla_model_3[1]))
print('coeficiente de correlacion de pearson: ' + str(tupla_model_3[2]))
...
data_model_S = {
    'Año': [2020, 2021, 2022, 2023, 2024],
    'Modelo': ['Model S', 'Model S', 'Model S', 'Model S', 'Model S'],
    'Precio (EUR)': [89990, 91990, 93990, 95990, 97990]
}

def regresion_lineal_model_s():
  df = pd.DataFrame(data_model_S)
  y = df['Año']
  x = df['Precio (EUR)']
  x_mean = np.mean(x)
  y_mean = np.mean(y)
  ...
  ordenada_al_origen = y_mean - pendiente * x_mean
  coef = np.corrcoef(x, y)[0, 1]
  tupla_model_S = (pendiente, ordenada_al_origen, coef)
  return tupla_model_S

tupla_model_S = regresion_lineal_model_s()
print('pendiente: ' + str(tupla_model_S[0]))
print('ordenada al origen: ' + str(tupla_model_S[1]))
print('coeficiente de correlacion de pearson: ' + str(tupla_model_S[2]))
...
data_model_X = {
    'Año': [2020, 2021, 2022, 2023, 2024],
    'Modelo': ['Model X', 'Model X', 'Model X', 'Model X', 'Model X'],
    'Precio (EUR)': [99990, 101990, 103990, 105990, 107990]
}

def regresion_lineal_model_x():
  df = pd.DataFrame(data_model_X)
  y = df['Año']
  x = df['Precio (EUR)']
  x_mean = np.mean(x)
  y_mean = np.mean(y)
  ...
  ordenada_al_origen = y_mean - pendiente * x_mean
  coef = np.corrcoef(x, y)[0, 1]
  tupla_model_X = (pendiente, ordenada_al_origen, coef)
  return tupla_model_X

tupla_model_X = regresion_lineal_model_x()
print('pendiente: ' + str(tupla_model_X[0]))
print('ordenada al origen: ' + str(tupla_model_X[1]))
print('coeficiente de correlacion de pearson: ' + str(tupla_model_X[2]))
...
data_model_Y = {
    'Año': [2020, 2021, 2022, 2023, 2024],
    'Modelo': ['Model Y', 'Model Y', 'Model Y', 'Model Y', 'Model Y'],
    'Precio (EUR)': [44990, 46990, 48990, 50990, 52990]
}

def regresion_lineal_model_y():
  df = pd.DataFrame(data_model_Y)
  y = df['Año']
  x = df['Precio (EUR)']
  x_mean = np.mean(x)
  y_mean = np.mean(y)
  ...
  ordenada_al_origen = y_mean - pendiente * x_mean
  coef = np.corrcoef(x, y)[0, 1]
  tupla_model_Y = (pendiente, ordenada_al_origen, coef)
  return tupla_model_Y

tupla_model_Y = regresion_lineal_model_y()
print('pendiente: ' + str(tupla_model_Y[0]))
print('ordenada al origen: ' + str(tupla_model_Y[1]))
print('coeficiente de correlacion de pearson: ' + str(tupla_model_Y[2]))
